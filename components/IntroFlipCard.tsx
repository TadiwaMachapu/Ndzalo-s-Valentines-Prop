...
interface IntroFlipCardProps {
  recipientName: string
  onComplete: () => void
}

export default function IntroFlipCard({ recipientName, onComplete }: IntroFlipCardProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <motion.div
        ...
        onClick={handleClick}
        whileHover={!isFlipping ? { scale: 1.02, y: -6 } : {}}
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              animate={!isFlipping ? { scale: [1, 1.08, 1] } : {}}
            ...
            <motion.div
              ...
              animate={
                sealBroken
                  ? { scale: [1, 1.3, 0], opacity: [1, 1, 0], rotate: [0, 0, 45] }
                  : { scale: [1, 1.05, 1] }
              }
              transition={
                sealBroken
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 4px 12px rgba(190,24,93,0.5), inset 0 2px 4px rgba(255,255,255,0.2)',
                }}
              >
              ...
              {sealBroken && (
                <>
                  ...
                  <motion.div
                    ...
                    style={{ background: 'linear-gradient(135deg, #be185d 0%, #9f1239 100%)' }}
                    initial={{ x: 0, y: 0, rotate: 0 }}
                    animate={{ x: 20, y: -10, rotate: 25, opacity: 0 }}
                    transition={{ duration: 0.5 }}
                  />
                </>
              )}
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
              <motion.div
                initial={{ scale: 0 }}
                animate={isFlipping ? { scale: [0, 1.2, 1] } : { scale: 0 }}
              ...
              <motion.p
                ...
                initial={{ opacity: 0 }}
                animate={isFlipping ? { opacity: 1 } : { opacity: 0 }}
